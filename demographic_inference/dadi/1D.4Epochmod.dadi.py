...
# usage:
# python 1D.Bottleneck.dadi.py --runNum $i --pop Vaquita --mu 5.8E-09 --L 481881665 --sfs [path to sfs] --outdir [path to outdir] Note: Please see the wrapper script were this line is incorporated to run this script from the wrapper
